...
class Validation
{
	...
	{
		add_action('wp_ajax_ssn_validator_parse_csv', array('D3\\SSN\\Validation', 'validateSSN'));
		add_action('wp_ajax_nopriv_ssn_validator_parse_csv', array('D3\\SSN\\Validation', 'validateSSN'));
	}
